...
`,Rt=({selectedDate:n,setSelectedDate:i})=>{const r=["To do","In progress","Done"];return e.jsxs(e.Fragment,{children:[e.jsx(wt,{selectedDate:n,setSelectedDate:i}),e.jsx(Lt,{children:r.map(o=>e.jsx(qt,{title:o,collection:""},f.useId()))})]})},At=()=>{const[n,i]=f.useState(Date.now()),[r,o]=f.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsxs(J,{children:[e.jsx(K,{selectedDate:n,typeDateDay:r,setSelectedDate:i}),e.jsx(it,{typeDateDay:r,setType:o})]}),r?e.jsx(Rt,{selectedDate:n,setSelectedDate:i}):e.jsx(ht,{selectedDate:n,setSelectedDate:i})]})},Gt=()=>e.jsx(Q,{children:e.jsx(At,{})});export{Gt as default};
