import{s as i,j as e,r as s,u as v}from"./index-14ee80d0.js";import j from"./sidebar-2b3e755b.js";import{M as k}from"./Modal-e36d06f4.js";import{u as y}from"./formik.esm-6ad12484.js";import{c as A,a as g}from"./index.esm-bbe4298a.js";import{G as B}from"./iconBase-5c059716.js";import"./index.esm-589db7d2.js";const L=i.section`
  margin-top: 24px;
  margin-left: 20px;
  margin-right: 20px;
  width: 335px;
...
`,U=({onOpenModal:t})=>e.jsx(I,{onClick:t,children:"Feedback"});function M(t){return B({tag:"svg",attr:{viewBox:"0 0 576 512"},child:[{tag:"path",attr:{d:"M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"}}]})(t)}let p;const Y=new Uint8Array(16);function z(){if(!p&&(p=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!p))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return p(Y)}const o=[];for(let t=0;t<256;++t)o.push((t+256).toString(16).slice(1));function H(t,n=0){return o[t[n+0]]+o[t[n+1]]+o[t[n+2]]+o[t[n+3]]+"-"+o[t[n+4]]+o[t[n+5]]+"-"+o[t[n+6]]+o[t[n+7]]+"-"+o[t[n+8]]+o[t[n+9]]+"-"+o[t[n+10]]+o[t[n+11]]+o[t[n+12]]+o[t[n+13]]+o[t[n+14]]+o[t[n+15]]}const N=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),u={randomUUID:N};function F(t,n,d){if(u.randomUUID&&!n&&!t)return u.randomUUID();t=t||{};const r=t.random||(t.rng||z)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,n){d=d||0;for(let a=0;a<16;++a)n[d+a]=r[a];return n}return H(r)}const Q=i.div`
  min-width: 280px;
  padding: 28px 20px;
  margin: 0 auto;
  border-radius: 8px;
