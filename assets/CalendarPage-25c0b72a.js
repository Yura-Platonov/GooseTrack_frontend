import{j as e,r as f,s as h}from"./index-14ee80d0.js";import{r as F,t as y,b as H,g as P,s as W,n as d,c as O,f as j,d as V,e as N,h as G,i as _,j as Z,k as E,P as u,T as J,a as K,C as Q}from"./CalendarPage.styled-4488bd75.js";import{F as U}from"./formik.esm-6ad12484.js";import{I as X}from"./index.esm-589db7d2.js";import{G as z}from"./iconBase-5c059716.js";import{M as Y}from"./Modal-e36d06f4.js";import"./index-151820b8.js";function k(n,i){var r;F(1,arguments);var o=n||{},p=y(o.start),c=y(o.end),l=c.getTime();if(!(p.getTime()<=l))throw new RangeError("Invalid interval");var a=[],s=p;s.setHours(0,0,0,0);var x=Number((r=i==null?void 0:i.step)!==null&&r!==void 0?r:1);if(x<1||isNaN(x))throw new RangeError("`options.step` must be a number greater than 1");for(;s.getTime()<=l;)a.push(y(s)),s.setDate(s.getDate()+x),s.setHours(0,0,0,0);return a}function T(n,i){var r,o,p,c,l,a,s,x;F(1,arguments);var w=P(),m=H((r=(o=(p=(c=i==null?void 0:i.weekStartsOn)!==null&&c!==void 0?c:i==null||(l=i.locale)===null||l===void 0||(a=l.options)===null||a===void 0?void 0:a.weekStartsOn)!==null&&p!==void 0?p:w.weekStartsOn)!==null&&o!==void 0?o:(s=w.locale)===null||s===void 0||(x=s.options)===null||x===void 0?void 0:x.weekStartsOn)!==null&&r!==void 0?r:0);if(!(m>=0&&m<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var g=y(n),b=g.getDay(),C=(b<m?-7:0)+6-(b-m);return g.setDate(g.getDate()+C),g.setHours(23,59,59,999),g}function q(){for(var n=arguments.length,i=new Array(n),r=0;r<n;r++)i[r]=arguments[r];return W(i)}const tt=d.div``,et=d.button`
  width: 76px;
  height: 34px;
  padding: 8px 16px;
...
`,at=({selectedDate:n})=>{const i=window.innerWidth<768,r=O(n,{weekStartsOn:1}),o=T(n,{weekStartsOn:1}),p=k({start:r,end:o});return e.jsx(e.Fragment,{children:e.jsx(rt,{children:p.map((c,l=f.useId())=>e.jsxs(ot,{children:[e.jsx("p",{children:j(c,i?"eeeee":"eee")})," "]},l))})})},st=n=>q`
  //color: ${n.color};
...
`,pt=({selectedDate:n,setSelectedDate:i})=>{const r=V(n),o=N(n),p=O(r,{weekStartsOn:1}),c=T(o,{weekStartsOn:1}),l=k({start:p,end:c});if(l.length<36){const a=G(c,1);l.push(...k({start:_(c,1),end:a}))}return e.jsx(dt,{children:l.map((a,s=f.useId())=>e.jsx(lt,{onClick:()=>i(a),children:e.jsx(ct,{currentMonth:!!Z(a,n),currentDay:!!E(a,n),children:j(a,"d")})},s))})},ht=({selectedDate:n,setSelectedDate:i})=>e.jsxs(e.Fragment,{children:[e.jsx(at,{selectedDate:n}),e.jsx(pt,{selectedDate:n,setSelectedDate:i})]}),xt=n=>q`
  background-color: ${n.currentDay};
`,ut=d.div`
  display: flex;
  gap: 19px;
...
`,wt=({selectedDate:n,setSelectedDate:i})=>{const r=window.innerWidth<768,o=O(n,{weekStartsOn:1}),p=T(n,{weekStartsOn:1}),c=k({start:o,end:p});return e.jsx(e.Fragment,{children:e.jsx(ut,{children:c.map((l,a=f.useId())=>e.jsxs(mt,{onClick:()=>i(l),children:[e.jsx(gt,{children:j(l,r?"eeeee":"eee")}),e.jsx(ft,{currentDay:!!E(l,n),children:j(l,"d")})]},a))})})},vt=d.div`
  display: flex;
  width: 100%;
  height: 38px;
  align-items: center;
...
`,Rt=({selectedDate:n,setSelectedDate:i})=>{const r=["To do","In progress","Done"];return e.jsxs(e.Fragment,{children:[e.jsx(wt,{selectedDate:n,setSelectedDate:i}),e.jsx(Lt,{children:r.map(o=>e.jsx(qt,{title:o,collection:""},f.useId()))})]})},At=()=>{const[n,i]=f.useState(Date.now()),[r,o]=f.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsxs(J,{children:[e.jsx(K,{selectedDate:n,typeDateDay:r,setSelectedDate:i}),e.jsx(it,{typeDateDay:r,setType:o})]}),r?e.jsx(Rt,{selectedDate:n,setSelectedDate:i}):e.jsx(ht,{selectedDate:n,setSelectedDate:i})]})},Zt=()=>e.jsx(Q,{children:e.jsx(At,{})});export{Zt as default};
