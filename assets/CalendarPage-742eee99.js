import{j as t,r as x}from"./index-3bc80ce9.js";import{r as k,t as g,a as C,g as S,s as O,n as i,b as w,f as m,d as $,e as M,h as T,i as z,j as A,k as j,I as q,T as B,P as W,C as E}from"./CalendarPage.styled-a94a1a9f.js";import"./hoist-non-react-statics.cjs-3f8ebaa8.js";import{G}from"./iconBase-9e3ff6b2.js";function f(e,n){var r;k(1,arguments);var o=e||{},c=g(o.start),s=g(o.end),a=s.getTime();if(!(c.getTime()<=a))throw new RangeError("Invalid interval");var d=[],l=c;l.setHours(0,0,0,0);var p=Number((r=n==null?void 0:n.step)!==null&&r!==void 0?r:1);if(p<1||isNaN(p))throw new RangeError("`options.step` must be a number greater than 1");for(;l.getTime()<=a;)d.push(g(l)),l.setDate(l.getDate()+p),l.setHours(0,0,0,0);return d}function v(e,n){var r,o,c,s,a,d,l,p;k(1,arguments);var b=S(),u=C((r=(o=(c=(s=n==null?void 0:n.weekStartsOn)!==null&&s!==void 0?s:n==null||(a=n.locale)===null||a===void 0||(d=a.options)===null||d===void 0?void 0:d.weekStartsOn)!==null&&c!==void 0?c:b.weekStartsOn)!==null&&o!==void 0?o:(l=b.locale)===null||l===void 0||(p=l.options)===null||p===void 0?void 0:p.weekStartsOn)!==null&&r!==void 0?r:0);if(!(u>=0&&u<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var h=g(e),y=h.getDay(),I=(y<u?-7:0)+6-(y-u);return h.setDate(h.getDate()+I),h.setHours(23,59,59,999),h}function D(){for(var e=arguments.length,n=new Array(e),r=0;r<e;r++)n[r]=arguments[r];return O(n)}const H=i.div``,N=i.button`
  width: 76px;
  height: 34px;
  padding: 8px 16px;
